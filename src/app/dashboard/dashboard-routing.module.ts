...
const routes: Routes = [
  {
    ...
    children: [
...

      {
        path: 'cls',
        loadChildren: () =>
          import('src/app/components/custom-pages/classes/classes.module').then(
            (m) => m.ClassesModule
          ),
      },

      {
        path: 'c',
        loadChildren: () =>
          import('src/app/components/custom-pages/courses/courses.module').then(
            (m) => m.CoursesModule
          ),
      },

      {
        path: 'c/details',
        loadChildren: () =>
          import('src/app/components/custom-pages/courses/course-details/course-details.module').then(
